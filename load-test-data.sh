...
printf "\n"
curl -X POST -H "Content-Type: application/json" -d '{"farmerCode":"fa000001","isOwner":true,"fieldName":"GAT 123/456/13","soilType":"Black Moist","waterSrc":["Well","Canal"],"cropID":"c003","varID":"e003","plotArea":0.1328,"plantationDate":"20-10-2020","harvestDate":"31-12-2020","geoLoc":[[73.97596098,20.13821597],[73.97652324,20.13804568],[73.97645686,20.13786908],[73.97588924,20.13803057],[73.97596098,20.13821597]]}' http://localhost:8000/master/create/origin/GFPCL
printf "\n"
curl -X POST -H "Content-Type: application/json" -d '{"farmerCode":"fa000002","isOwner":true,"fieldName":"GAT 123/456/14","soilType":"Black Moist","waterSrc":["Well","Canal"],"cropID":"c003","varID":"e003","plotArea":0.4,"plantationDate":"20-10-2020","harvestDate":"31-12-2020","geoLoc":[[74.7490504,19.08653731],[74.74916808,19.08700466],[74.75038949,19.08676132],[74.75025002,19.08614981],[74.7490504,19.08653731]]}' http://localhost:8000/master/create/origin/GFPCL
printf "\n"
curl -X POST -H "Content-Type: application/json" -d '{"farmerCode":"fa000001","isOwner":true,"fieldName":"GAT 123/456/15","soilType":"Black Moist","waterSrc":["Well","Canal"],"cropID":"c005","varID":"e005","plotArea":0.0025,"plantationDate":"20-10-2020","harvestDate":"31-12-2020","geoLoc":[[73.99155132,20.22938708],[73.99154127,20.22935594],[73.99149198,20.2293616],[73.99150405,20.22941319],[73.99155132,20.22938708]]}' http://localhost:8000/master/create/origin/GFPCL
printf "\n"
curl -X POST -H "Content-Type: application/json" -d '{"farmerCode":"fa000002","isOwner":true,"fieldName":"GAT 123/456/16","soilType":"Black Moist","waterSrc":["Well","Canal"],"cropID":"c005","varID":"e005","plotArea":0.0025,"plantationDate":"20-10-2020","harvestDate":"31-12-2020","geoLoc":[[73.99155132,20.22938708],[73.99154127,20.22935594],[73.99149198,20.2293616],[73.99150405,20.22941319],[73.99155132,20.22938708]]}' http://localhost:8000/master/create/origin/GFPCL
printf "\n"
...
printf ""
curl -X POST -H "Content-Type: application/json" -d '{"fromLoc":"fe000001","toLoc":"ab000001","materialCode":"c003e003","skuCode":"ea000001","skuQuantity":90,"totalWeight":623,"price":55.0,"rejection":78,"date":"11-12-2020","locationCost":26654,"transferCost":900}' http://localhost:8000/operations/inward/GFPCL
printf ""
curl -X POST -H "Content-Type: application/json" -d '{"fromLoc":"fe000002","toLoc":"ab000001","materialCode":"c003e003","skuCode":"ea000001","skuQuantity":190,"totalWeight":1327,"price":47.3,"rejection":99,"date":"12-12-2020","locationCost":34654,"transferCost":1000}' http://localhost:8000/operations/inward/GFPCL
printf ""
...
printf ""
curl -X POST -H "Content-Type: application/json" -d '{"fromLoc":"fe000002","toLoc":"ab000001","materialCode":"c005e005","skuCode":"ea000001","skuQuantity":150,"totalWeight":1194,"price":28.6,"rejection":13,"date":"14-12-2020","locationCost":13654,"transferCost":800}' http://localhost:8000/operations/inward/GFPCL
printf ""
...
curl -X POST -H "Content-Type: application/json" -d '{"fromLoc":"ab000001","toLoc":"ab000002","materialCode":"c003e003","btuCodeList":["1000001c","1000001d","1000001e","1000001f","10000020","10000021","10000022"],"price":27,"date":"10-12-2020","locationCost":122,"transferCost":134}' http://localhost:8000/operations/dispatch/GFPCL
printf ""
curl -X POST -H "Content-Type: application/json" -d '{"fromLoc":"ab000002","toLoc":"ab000004","materialCode":"c003e003","btuCodeList":["1000001c","1000001d","1000001e","1000001f","10000020","10000021","10000022"],"price":27,"date":"10-12-2020","locationCost":122,"transferCost":134}' http://localhost:8000/operations/dispatch/GFPCL
printf ""
